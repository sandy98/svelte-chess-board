...
var ChessBoard = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 16, 4, 722);
    ...
    function create_each_block_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block_3.name, type: "each", source: "(6:5) {#each row as sq, x}", ctx });
    	return block;
    }

    // (4:4) {#each currentRows as row, y}
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(changed, ctx) {
    			if (changed.currentRows || changed.utils || changed.__sqFrom || changed.__darkBg || changed.__lightBg || changed.position || changed.sets || changed.__set || changed.canMoveFrom || changed.turn) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block_2.name, type: "each", source: "(4:4) {#each currentRows as row, y}", ctx });
    	return block;
    }
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 36, 49, 1382);
    			add_location(div, file, 36, 8, 1341);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 60, 5, 2028);
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(60:2) {#each history as san, i}", ctx });
    	return block;
    }

    function create_fragment(ctx) {
    	var div8, div1, t0, div0, t1, div7, div4, div2, t2, div3, span0, t3, t4, t5, span1, t6, t7, div5, h20, t9, div6, h21, dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 30, 1, 1180);
    			attr_dev(div1, "class", "board-child board");
    			add_location(div1, file, 2, 2, 108);
    			attr_dev(div2, "class", "headers");
    			add_location(div2, file, 45, 3, 1700);
    			attr_dev(span0, "class", "san");
    			set_style(span0, "background", (ctx.__current === 0 ? ctx.__darkBg : ctx.__lightBg));
    			set_style(span0, "border", (ctx.__current === 0 ? 'none' : 'dashed 1px'));
    			add_location(span0, file, 51, 5, 1802);
    			attr_dev(span1, "class", "san");
    			add_location(span1, file, 69, 5, 2249);
    			attr_dev(div3, "class", "history");
    			add_location(div3, file, 47, 3, 1735);
    			attr_dev(div4, "class", "board-panel-child");
    			set_style(div4, "display", (ctx.__status === 'PLAY' || ctx.__status === 'VIEW' || ctx.__status === 'ANALYZE' ? 'flex' : 'none'));
    			add_location(div4, file, 41, 4, 1549);
    			set_style(h20, "padding", "5px");
    			add_location(h20, file, 83, 3, 2463);
    			attr_dev(div5, "class", "board-panel-child");
    			set_style(div5, "display", (ctx.__status === 'SETUP' ? 'flex' : 'none'));
    			add_location(div5, file, 78, 1, 2359);
    			set_style(h21, "padding", "5px");
    			add_location(h21, file, 90, 3, 2615);
    			attr_dev(div6, "class", "board-panel-child");
    			set_style(div6, "display", (ctx.__status === 'CONFIG' ? 'flex' : 'none'));
    			add_location(div6, file, 85, 1, 2510);
    			attr_dev(div7, "class", "board-child board-panel");
    			set_style(div7, "color", ctx.__darkBg);
    			set_style(div7, "background", "beige");
    			add_location(div7, file, 40, 2, 1461);
    			attr_dev(div8, "class", "board-frame");
    			add_location(div8, file, 1, 0, 36);

    			dispose = [
    				listen_dev(div1, "dblclick", ctx.flip),
    				listen_dev(span0, "click", ctx.click_handler_2),
    				listen_dev(span1, "click", ctx.click_handler_4),
    				listen_dev(div8, "keypress", ctx.keypress_handler)
    			];
    		},
    ...
    ///////////////////////////////////////////////////////////////////////////////
      ...
      onMount(() => {
    	  ...
    	  // setStatus('PLAY')
    	//   setTimeout(() => {
    	// 	  panelElement.style.top = getPanelTop()
    	// 	  panelElement.style.left = getPanelLeft()
    	//   }, 0)
    	//  setTimeout(() => window.board = document.querySelector('chess-board'), 0)
      });

    	const writable_props = ['initialFen', 'autoPromotion', 'initialStatus', 'humanSide', 'figureSets', 'boardElement', 'historyElement', 'panelElement', 'isCheck', 'isCheckMate', 'turn', '__imgSrc', '__figureFrom', '__figureTo', '__sqFrom', '__sqTo', '__promotion'];
    	...
    	$$self.$$.update = ($$dirty = { __flipped: 1, __current: 1, __sqTo: 1, __darkBg: 1, __lightBg: 1, __figureFrom: 1, boardElement: 1, panelElement: 1, promotionBg: 1, __isPromoting: 1 }) => {
    		...
    		if ($$dirty.__current) { $$invalidate('position', position = game.positions[__current]); }
    ...
    class ChessBoard extends SvelteElement {
    	constructor(options) {
    		...
    		this.shadowRoot.innerHTML = `<style>::-webkit-scrollbar{width:7px}::-webkit-scrollbar-track{background:#f1f1f1}::-webkit-scrollbar-thumb{background:#bbb}::-webkit-scrollbar-thumb:hover{background:#888}.board-frame{display:flex;flex-direction:column;width:320px;max-width:320px;min-width:320px;height:640px;max-height:640px;min-height:640px;-webkit-user-select:none;-webkit-touch-callout:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.board-child{width:100%;max-width:100%;min-width:100%;height:50%;max-height:50%;min-height:50%;margin-top:0;border:solid 1px black}.board{display:flex;flex-direction:column;background:steelblue;color:whitesmoke}.row{display:flex;flex-direction:row;height:12.5%;min-height:12.5%;max-height:12.5%;width:100%;max-width:100%;min-width:100%}.row:nth-child(even){background:whitesmoke}.row:nth-child(odd){background:cyan}.square{display:flex;justify-content:center;align-items:center;height:100%;min-height:100%;max-height:100%;width:12.5%;max-width:12.5%;min-width:12.5%}.board-panel-child{display:flex;flex-direction:column;justify-content:space-between;align-items:stretch;width:100%;max-width:100%;min-width:100%;height:100%;max-height:100%;min-height:100%}.headers{display:flex;flex-direction:column;justify-content:space-evenly;width:100%;max-width:100%;min-width:100%;height:40%;max-height:40%;min-height:40%;border-bottom:solid 1px black}.history{display:flex;flex-direction:row;flex-wrap:wrap;justify-content:flex-start;justify-items:flex-start;align-items:flex-start;width:95%;max-width:95%;min-width:95%;height:50%;max-height:50%;min-height:50%;overflow-y:auto;font-family:monospace;font-size:10pt;padding:5px}.san{cursor:pointer;padding:3px;padding-bottom:5px;height:0.75em;max-height:0.75em;min-height:0.75em;margin-right:0.35em;margin-bottom:8px}.san:hover{opacity:0.5}.promotion-panel{position:absolute;flex-direction:row;z-index:1000;width:160px;min-width:160px;max-width:160px;height:40px;min-height:40px;max-height:40px;border:solid 1px black}.promotion-panel>div{width:25%;min-width:25%;max-width:25%;height:100%;min-height:100%;max-height:100%}@media only screen and (min-width: 640px){.board-frame{flex-direction:row;width:640px;max-width:640px;min-width:640px;height:320px;max-height:320px;min-height:320px;margin-top:20px;margin-left:20px}.board-child{width:50%;max-width:50%;min-width:50%;height:100%;max-height:100%;min-height:100%}}@media only screen and (min-width: 1280px){.board-frame{width:800px;max-width:800px;min-width:800px;height:400px;max-height:400px;min-height:400px}.promotion-panel{width:200px;min-width:200px;max-width:200px;height:50px;min-height:50px;max-height:50px}}@media only screen and (min-width: 1600px){.board-frame{width:960px;max-width:960px;min-width:960px;height:480px;max-height:480px;min-height:480px}.promotion-panel{width:240px;min-width:240px;max-width:240px;height:60px;min-height:60px;max-height:60px}}
		/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */</style>`;

    		init(this, { target: this.shadowRoot }, instance, create_fragment, safe_not_equal, ["utils", "initialFen", "game", "autoPromotion", "states", "initialStatus", "getStatus", "setStatus", "humanSide", "getHuman", "setHuman", "getCurrentRows", "getFlipped", "flip", "getCurrent", "goto", "getPosition", "figureSets", "getFigureSet", "setFigureSet", "backgrounds", "getBackgrounds", "setBackgrounds", "boardElement", "historyElement", "panelElement", "refresh", "remote_move", "isCheck", "isCheckMate", "getCheck", "getCheckMate", "try_move", "undo", "reset", "getHistory", "getResult", "turn", "getTurn", "canMoveFrom", "__imgSrc", "__figureFrom", "__figureTo", "__sqFrom", "__sqTo", "__promotion", "load_pgn"]);
    	...
    	static get observedAttributes() {
    		return ["utils","initialFen","game","autoPromotion","states","initialStatus","getStatus","setStatus","humanSide","getHuman","setHuman","getCurrentRows","getFlipped","flip","getCurrent","goto","getPosition","figureSets","getFigureSet","setFigureSet","backgrounds","getBackgrounds","setBackgrounds","boardElement","historyElement","panelElement","refresh","remote_move","isCheck","isCheckMate","getCheck","getCheckMate","try_move","undo","reset","getHistory","getResult","turn","getTurn","canMoveFrom","__imgSrc","__figureFrom","__figureTo","__sqFrom","__sqTo","__promotion","load_pgn"];
    	}
